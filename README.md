...
- March, 2023: [Audio-Visual Speech-To-Text Translation](https://arxiv.org/abs/2303.05309) may also interest you.
...
Suppose {train,valid}.tsv are saved at ```/manifest/to/S1/dataset```, and their corresponding character transcripts {train,valid}.unit and [dict.unit.txt](https://zjueducn-my.sharepoint.com/:t:/g/personal/rongjiehuang_zju_edu_cn/Ea5b_NwrBdNGlmNOun6V84sBGdAvFrl1ob2QrBwTYSDSYw?e=Rua4mN) are saved at ```/unit/to/S2/dataset```.
