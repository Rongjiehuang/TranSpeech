    ...
    def load_checkpoint(
        ...
        if bexists:
            ...
            try:
                ...
                # After the model is trained. ASR could use get_reserve_head_index and _adaptive_prune_heads functions to get the top X heads with most importance.
                # Then user uses the rank to prune a new roberta encoder and save the pruned ckpt manually.
                # ASR will fine tune the the new roberta encoder via the ckpt saved above
                ...
                # Fine tune model (e.g. roberta encoder) on a certain datasets with regularization
                # After the model is trained. ASR could use _get_fc_rank and _prune_fc_layer functions to get the top X units with most importance.
                # Then user uses the rank to prune a new roberta encoder and save the pruned ckpt manually.
                # ASR will fine tune the the new roberta encoder via the ckpt saved above
